...
import 'package:home_rental/controllers/comman_dailog.dart';
import 'package:home_rental/models/product_model.dart';
  ...
  Future<void> addNewProduct(Map productdata, File image) async {
    ...
    try {
      ...
      var response = await firebaseInstance.collection('productlist').add({
        ...
        "latt_data": productdata['la_data'],
        "long_data": productdata['lo_data'],
        "location_data": productdata['loc_data'],
      });
          ...
          (result) {
            ...
            lodadedProduct.add(
              Product(
                ...
                lattitude: double.parse(result['latt_data']),
                longitude: double.parse(result['long_data']),
              ),
            );
          },
        );
